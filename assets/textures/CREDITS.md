...
| Файл | Що це | Джерело |
|---|---|---|
| `aa2aea42-dc41-4116-b5f9-f24daef4c231.png` | Вихідний атлас: 5 фішок розбійника в ряд (purple/red/blue/yellow/green) | Надано користувачем (джерело уточнити) |
| `robber-purple.png` … `robber-green.png` | Ті самі 5 фішок, вирізані з атласу (BFS-кроп по темному тлу + альфа-канал, прозорий фон) | Згенеровано з атласу вище |
