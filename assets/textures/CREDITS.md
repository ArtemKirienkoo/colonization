...
| Файл | Що це | Джерело |
|---|---|---|
| `btn-0.png` … `btn-7.png` | 8 кнопок-каменів, вирізані з вихідного атласа (PIL: обрізка по силуету каменя + альфа-канал, прозорий фон навколо). Атлас `686f0e79-46c7-4639-963d-6188c84289c4.png` видалено з репозиторію як невикористаний | Надано користувачем (джерело уточнити) |
...
## `markers/` — фішки розбійника

| Файл | Що це | Джерело |
|---|---|---|
| `robber-purple.png` … `robber-green.png` | 5 фішок, вирізані з вихідного атласа `aa2aea42-dc41-4116-b5f9-f24daef4c231.png` (BFS-кроп по темному тлу + альфа-канал, прозорий фон). Атлас видалено з репозиторію як невикористаний | Надано користувачем (джерело уточнити) |

Використання: `src/ui/index.html` — лоадер `robberTextures` + `drawRobberMarker()`.
Спрайт малюється на пустелі та на звичайних гексах; колір фішки = колір гравця,
що поставив розбійника (`gameState.robber.color`), за замовчуванням purple.
Старий канвас-токен лишено fallback'ом на час завантаження спрайта.
